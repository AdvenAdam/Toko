                ...
                <div class="col-12 py-5">
                    <div class="grid">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <a href="/Diskon/excelPendingin" class="btn btn-success btn-sm"><i class="mdi mdi-file-excel-box"></i> Export ke Excel</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
            ...
            <?php foreach ($pendingin as $val) { ?>
                <div class="modal fade" id="modal_edit<?= $val['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="/diskon/updatePendingin/<?= $val['id']; ?>" method="POST">
