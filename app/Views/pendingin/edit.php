                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <form action="/pendingin/update/<?= $pendingin['id']; ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                ...
                                                <div class="col-sm-4">
                                                    <select class="custom-select form-control <?= ($validation->hasError('merk')) ? 'is-invalid' : ''; ?>" id="merk" name="merk" value="">
                                                        <option value="<?= (old('merk')) ? (old('merk')) : $pendingin['merk'] ?>" selected><?= (old('merk')) ? (old('merk')) : $pendingin['merk']  ?></option>
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                ...
                                                <div class="col-sm-5">
                                                    <input type="text" class="form-control input_mask_currency <?= ($validation->hasError('harga')) ? 'is-invalid' : ''; ?>" require id="harga" name="harga" value="<?= (old('harga')) ? (old('harga')) : $pendingin['harga']; ?>">
                                                    <div class="invalid-feedback">
