                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <form action="/vga/update/<?= $vga['id']; ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                ...
                                                <div class="col-sm-4">
                                                    <select class="custom-select form-control <?= ($validation->hasError('merk')) ? 'is-invalid' : ''; ?>" id="merk" name="merk" value="">
                                                        <option value="<?= (old('merk')) ? (old('merk')) : $vga['merk'] ?>" selected><?= (old('merk')) ? (old('merk')) : $vga['merk']  ?></option>
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                ...
                                                <div class="col-sm-5">
                                                    <input type="text" class="form-control input_mask_currency <?= ($validation->hasError('harga')) ? 'is-invalid' : ''; ?>" require id="harga" name="harga" value="<?= (old('harga')) ? (old('harga')) : $vga['harga']; ?>">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" onkeypress="return event.charCode >= 48 && event.charCode <=57" class="form-control <?= ($validation->hasError('stok')) ? 'is-invalid' : ''; ?>" require id="stok" name="stok" value="<?= (old('stok')) ? (old('stok')) : $vga['stok']; ?>">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" onkeypress="return event.charCode >= 48 && event.charCode <=57" class="form-control <?= ($validation->hasError('base_clock')) ? 'is-invalid' : ''; ?>" require id="base_clock" name="base_clock" value=" <?= (old('base_clock')) ? (old('base_clock')) : $vga['base_clock']; ?>">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" onkeypress="return event.charCode >= 48 && event.charCode <=57" class="form-control <?= ($validation->hasError('boost_clock')) ? 'is-invalid' : ''; ?>" require id="boost_clock" name="boost_clock" value=" <?= (old('boost_clock')) ? (old('boost_clock')) : $vga['boost_clock']; ?>">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" onkeypress="return event.charCode >= 48 && event.charCode <=57" class="form-control <?= ($validation->hasError('ukuran_memori')) ? 'is-invalid' : ''; ?>" require id="ukuran_memori" name="ukuran_memori" value=" <?= (old('ukuran_memori')) ? (old('ukuran_memori')) : $vga['ukuran_memori']; ?>">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                <label for="lebar_memori" onkeypress="return event.charCode >= 48 && event.charCode <=57" class="col-sm-2 col-form-label">Lebar Memori</label>
                                                <div class="col-sm-3">
