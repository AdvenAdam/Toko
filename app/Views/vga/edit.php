                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <form action="/vga/update/<?= $vga['id']; ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" onkeypress="return event.charCode >= 48 && event.charCode <=57" class="form-control <?= ($validation->hasError('harga')) ? 'is-invalid' : ''; ?>" require id="harga" name="harga" value="<?= (old('harga')) ? (old('harga')) : $vga['harga']; ?>">
                                                    <div class="invalid-feedback">
