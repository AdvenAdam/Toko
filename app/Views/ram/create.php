                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <form action="/ram/save" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                ...
                                                <div class="col-sm-5">
                                                    <input type="text" onkeypress="return event.charCode >= 48 && event.charCode <=57" class="form-control <?= ($validation->hasError('ukuran_ram')) ? 'is-invalid' : ''; ?>" require id="ukuran_ram" name="ukuran_ram" value="<?= old('ukuran_ram'); ?>">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                ...
                                                <div class="col-sm-5">
                                                    <input type="text" onkeypress="return event.charCode >= 48 && event.charCode <=57" class="form-control <?= ($validation->hasError('frekuensi')) ? 'is-invalid' : ''; ?>" require id="frekuensi" name="frekuensi" value="<?= old('frekuensi'); ?>">
                                                    <div class="invalid-feedback">
