                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($service as $val) : ?>
                                        <tr align="middle">
                                            ...
                                            <td><a href="/service/<?= $val['slug']; ?>" class="btn btn-info btn-sm"><i class="mdi mdi-magnify"></i></a>
                                                <a href="/service/edit/<?= $val['slug']; ?>" class="btn btn-light btn-sm"><i class="mdi mdi-pencil-box-outline"></i></a>
