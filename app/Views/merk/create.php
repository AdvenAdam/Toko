                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <form action="/slider/save" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control <?= ($validation->hasError('baris_satu')) ? 'is-invalid' : ''; ?>" id="baris_satu" name="baris_satu" value="<?= old('baris_satu'); ?>">
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control <?= ($validation->hasError('baris_dua')) ? 'is-invalid' : ''; ?>" id="baris_dua" name="baris_dua" value="<?= old('baris_dua'); ?>">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                <label for="link" class="col-sm-2 col-form-label">Link Untuk Slider</label>
                                                <div class="col-sm-10">
